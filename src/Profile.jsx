        ...
        <div>
          <div className="linkContainer">
            <svg
              ...
              className={user.location ? "linkIcon" : "linkIcon greyedOut"}
              fill="var(--color-text)"
            >
            ...
            <p className={user.location ? "" : "greyedOut"}>
          ...
          <div className="linkContainer">
            <svg
              ...
              width="20"
              xmlns="http://www.w3.org/2000/svg"
              className={user.blog ? "linkIcon" : "linkIcon greyedOut"}
              fill="var(--color-text)"
            >
              <g>
            ...
            <p className={user.blog ? "" : "greyedOut"}>
        ...
        <div>
          <div className="linkContainer">
            <svg
              ...
              width="20"
              xmlns="http://www.w3.org/2000/svg"
              className={user.twitter ? "linkIcon" : "linkIcon greyedOut"}
              fill="var(--color-text)"
            >
            ...
            <p className={user.twitter ? "" : "greyedOut"}>
          ...
          <div className="linkContainer">
            <svg
              ...
              xmlns="http://www.w3.org/2000/svg"
              fill="var(--color-text)"
              className={user.company ? "linkIcon" : "linkIcon greyedOut"}
            >
            ...
            <p className={user.company ? "" : "greyedOut"}>
